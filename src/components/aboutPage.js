    ...
    render() {
      return (
        <div style={{ color: "white", textAlign: "center", bottom: "5px", width: "100%" }} className="about">
          ...
          <p style={{fontSize: "20px",width: "800px", textAlign: "center", marginLeft:"auto", marginRight:"auto"}}>Moodie was created using React.js and the Spotify API. We pull your top 50 tracks
          ...
          <br />
          <p style={{fontSize: "14px",width: "600px", textAlign: "center", marginLeft:"auto", marginRight:"auto"}}> 
